...
import 'package:flutter_advance/features/auth/data/models/sign_up_request_body.dart';
import 'package:flutter_advance/features/auth/data/models/sign_up_response.dart';
...
abstract class ApiService {
  ...
  Future<SignupResponse> signup(
      @Body() SignupRequestBody signRequestBody,
      );
}
